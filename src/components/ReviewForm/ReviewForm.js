    ...
    render() {
        return (
            <form>
                ...
                <p>El profesor organiza el contenido del curso de manera coherente.</p>
                ...
                <p>El profesor genera un ambiente de respeto hacia los alumnos.</p>
                ...
                <p>El profesor genera un ambiente organizado de trabajo y dispone recursos para facilitar el aprendizaje</p>
                ...
                <p>Es claro con sus asignaciones y su manera de comunicarse con los alumnos</p>
                ...
                <p>Su estrategia de enseñanza es coherente y significativa para los alumnos</p>
                ...
                <p>Su manera de explicar la clase es tratado de manera rigurosa y es fácil de comprender para los alumnos</p>
                ...
                <p>Promueve el desarrollo de pensamiento de los alumnos en la clase</p>
                ...
                <textarea name='comentarios' value={this.state.comentarios} onChange={e => this.change(e)}/>
